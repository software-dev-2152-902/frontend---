    ...
    return (
        <div className="h-screen bg-slate-50">
            ...
            <div
                ...
                className={`hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col bg-gradient-to-b from-green-900 to-green-800 px-6 pb-4 transition-all duration-300 ease-in-out ${isCollapsed ? 'w-20' : 'w-72'
                    }`}
            >
                <div className="flex h-16 shrink-0 items-center">
                    {!isCollapsed && <span className="text-2xl font-bold text-white">SAFMS</span>}
                </div>
                <nav className="flex flex-1 flex-col">
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        <li>
                                ...
                                {navigation.map((item) => {
                                    ...
                                    return (
                                        <li key={item.name}>
                                            <Link
                                                to={item.href}
                                                className={`group flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold ${isActive
                                                        ? 'bg-green-700 text-white'
                                                        : 'text-green-100 hover:bg-green-700 hover:text-white'
                                                    }`}
                                            >
